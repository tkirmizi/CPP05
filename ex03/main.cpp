...
/*   Updated: 2025/02/13 20:12:14 by taha             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	try {
		...
		AForm* form1 = intern.makeForm("presidential pardon", "Criminal1");
		AForm* form2 = intern.makeForm("robotomy request", "Bender2");
		AForm* form3 = intern.makeForm("shrubbery creation", "Garden3");
